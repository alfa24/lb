...
// When the browser is ready...
  ...
  var dataTable;
	...
	bootbox.confirm("Are you sure you want to pay provider ("+currencysymbol+amount+")?", function(result) {
	...
	bootbox.confirm("Are you sure you want to change payment status from pending to paid?", function(result) {
