...
{
	global $wpdb, $current_user, $service_finder_ThemeParams, $current_template, $registerErrors, $service_finder_Params, $paypal, $service_finder_Tables, $service_finder_Errors, $registerMessages,$wp_filesystem,$globalproviderid;
	switch($global_var){
	case 'wpdb':
		return $wpdb;
		break;
