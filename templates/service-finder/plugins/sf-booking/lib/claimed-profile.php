...
if((isset($payment_mode) || (isset($freemode) && $freemode == 'yes')) && ($payment_mode == 'paypal' || $payment_mode == 'wired' || (isset($freemode) && $freemode == 'yes')) && isset($claimedprofile) && $claimedbusinessid > 0 && $profileid > 0) {
...
if(isset($_GET['claimviapayumoney']) && $_GET['claimviapayumoney'] == 'success' && $_GET['payutransactionforreg'] == 'success' && isset($_GET['payutransactionforreg']) && isset($_POST['payuMoneyId']) && isset($_POST['status'])){
...
function service_finder_after_claimedpayment_admin($args,$cid){
global $wpdb, $service_finder_Tables, $service_finder_options;			
