...
function setGmapMarkers(map, locations,infostatus) {
    ...
    for (i = 0; i < locations.length; i++) {
        ...
        createGmapMarker(infobox_width , i, lat, lng, pin, title, image, link, proid, category, categorycolor, address, company,infostatus);
        // found the property
...
function createGmapMarker(infobox_width , i, lat, lng, pin, title, image, link, proid, category, categorycolor, address, company,infostatus) {
    "use strict";
    var marker, myLatLng;
    myLatLng = new google.maps.LatLng(lat, lng);
    ...
    google.maps.event.addListener(marker, 'click', function (event) {
		...
		if(showaddressinfo && accessaddressinfo){
