...
if(isset($_GET['invoicepaid']) && $_GET['invoicepaid'] == 'success' && $_GET['payutransaction'] == 'success' && isset($_GET['payutransaction']) && isset($_POST['payuMoneyId']) && isset($_POST['status'])){
...
Status: Paid';
			...
			$msg_body = str_replace($tokens,$replacements,$message);
			$msg_subject = 'Invoice Notification';
...
'.$_POST['comment'];
			...
			if(empty($res)){
			$userLink = service_finder_get_invoice_author_url($user_id,'',$_POST['invoiceid']);
