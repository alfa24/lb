...
<div class="profile-form-bx">
  <div class="margin-b-30 text-right"> <a href="#" data-toggle="modal" class="btn btn-primary" data-target="#invoice-Modal"><i class="fa fa-file-text-o"></i>
    ...
    <thead>
      <tr>
        <th class="text-nowrap"> <div class="checkbox">
          ...
          <button class="btn btn-danger btn-xs" id="deleteInvoiceTriger" title="Delete"><i class="fa fa-trash-o"></i></button></th>
            ...
            <div class="col-md-12">
              <div class="servicearea-group">
                <div class="form-group clearfix ">
                  <div class="col-xs-3">
                    <select title="Services" name="service_title[0]" data-index="0" class="form-control servicedrp">
                      <option value="new">
  ...
  <form method="post" class="edit-invoice default-hidden" id="editInvoice">
    ...
    <div class="col-md-6">
      <div class="form-group">
        <select title="Customer" name="customer" class="form-control">
          <?php 
								if(!empty($customers)){
									foreach($customers as $customer){
										echo '<option value="'.esc_attr($customer->email).'">'.$customer->name.' ('.$customer->email.')</option>';
    ...
    <div class="col-md-12">
      <div class="form-group">
        <textarea name="short-desc" cols="" rows="3+" class="form-control" placeholder="Enter text"></textarea>
      </div>
    </div>
    <div class="col-md-12">
            <?php
