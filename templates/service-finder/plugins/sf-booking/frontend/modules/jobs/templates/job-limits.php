...
<div class="profile-form-bx" id="sf-limit-bx">
...
<?php if($flag == 0){ ?>
<div class="alert alert-danger"><?php esc_html_e('There is no active plans.', 'service-finder'); ?></div>
<?php } ?>
<ul class="list-unstyled clear sf-plans-available margin-0">
    ...
    <li>
        <h5><?php echo sprintf( esc_html__('Limits with Package. Package Cycle from %s to %s', 'service-finder'), date('Y-m-d',strtotime($jobstartdate)),date('Y-m-d',strtotime($jobexpire)) ); ?></h5>
        <strong>
		<?php
  ...
  <form class="joblimit-payment-form sf-card-group" method="post">
	  ...
	  <?php
                ...
                if($key != 'wired' && $key != 'paypal-adaptive' && $key != 'cod' && $key != 'payulatam'){
				if($value){
				$falg = 1;
				}
                    if($key == 'stripe'){
      ...
      <div id="joblimitcardinfo" class="default-hidden">
        <div class="col-md-8">
          <div class="form-group">
            ...
            <div class="input-group"> <i class="input-group-addon fa fa-credit-card"></i>
              <input type="text" id="jcd_number" name="jcd_number" class="form-control">
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group"> <i class="input-group-addon fa fa-ellipsis-h"></i>
              <input type="text" id="jcd_cvc" name="jcd_cvc" class="form-control">
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select id="jcd_month" name="jcd_month" class="form-control" title="Select Month">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select id="jcd_year" name="jcd_year" class="form-control"  title="Select Year">
              <?php
											$year = date('Y');
      ...
      <div id="twocheckout_jobcardinfo" class="default-hidden">
        <div class="col-md-8">
          <div class="form-group">
            ...
            <div class="input-group"> <i class="input-group-addon fa fa-credit-card"></i>
              <input type="text" id="twocheckout_jcd_number" name="twocheckout_jcd_number" class="form-control">
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group"> <i class="input-group-addon fa fa-ellipsis-h"></i>
              <input type="text" id="twocheckout_jcd_cvc" name="twocheckout_jcd_cvc" class="form-control">
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select id="twocheckout_jcd_month" name="twocheckout_jcd_month" class="form-control" title="Select Month">
              <option value="1"><?php echo esc_html__('January', 'service-finder') ?></option>
              <option value="2"><?php echo esc_html__('February', 'service-finder')?></option>
              <option value="3"><?php echo esc_html__('March', 'service-finder')?></option>
              <option value="4"><?php echo esc_html__('April', 'service-finder')?></option>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select id="twocheckout_jcd_year" name="twocheckout_jcd_year" class="form-control"  title="Select Year">
              <?php
											$year = date('Y');
                                            for($i = $year;$i<=$year+50;$i++){
												echo '<option value="'.esc_attr($i).'">'.$i.'</option>';
