    ...
    <div class="col-md-12">
      <div class="form-group">
        <div class="input-group"> <span class="input-group-addon"><?php echo service_finder_currencysymbol(); ?></span>
          <input name="costing" readonly="readonly" type="text" class="form-control" placeholder="<?php esc_html_e('Cost', 'service-finder'); ?>">
        </div>
      </div>
    </div>
    <div class="col-md-12">
      <div class="form-group">
        <div class="input-group"> <span class="input-group-addon v-align-t"><i class="fa fa-pencil"></i></span>
          <textarea name="description" readonly="readonly" rows="4" class="form-control" placeholder="<?php esc_html_e('Description', 'service-finder'); ?>"></textarea>
        </div>
      </div>
    </div>
    </div>
