...
******************************************************************************/
	...
	jQuery('body').on('click', 'ul.timeslots li', function(){
...
// When the browser is ready...
  jQuery(function() {
	...
	//Display Bookings in Data Table
	var CustomerPastdataTable = jQuery('#pastbookings-customer-grid').DataTable( {
	"paging":   false,
	"ordering": false,
    "info":     false,
	"searching": false,
	...
	//Display Bookings in Data Table
	var CustomerUpcomingdataTable = jQuery('#upcomingbookings-customer-grid').DataTable( {
	"paging":   false,
	"ordering": false,
	"bAutoWidth": false,
	"searching": false,
	 ...
	 formID = 'addBookingInvoice';
							...
							bootbox
								...
								.on('hide.bs.modal', function(e) {
									...
									jQuery('.add-booking-invoice #total_amount').html('0.00');
									jQuery('.add-booking-invoice #total_discount').html('0.00');
									jQuery('.add-booking-invoice #total_tax').html('0.00');
									jQuery('.add-booking-invoice #grand_total').html('0.00');
