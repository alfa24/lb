...
$advancesearchview = (isset($service_finder_options['advance-search-view'])) ? esc_attr($service_finder_options['advance-search-view']) : 'mi';
...
$html = '<form class="clearfix search-providers" method="get" action="'.home_url('/').'">
  ...
  $html .= '<div class="'.$fieldclass.'">
    <div class="type-keyword">
      <input type="text" value="'.esc_attr($searchAddress).'" placeholder="'.esc_html__('Address', 'service-finder').'" id="searchAddress" name="searchAddress" class="form-control">
    </div>
  </div>';
  endif;
  if($service_finder_options['search-category']):
  ...
  $html .= '<div class="'.$submitclass.'">
    <div class="type-search">
      <input type="submit" value="'.esc_html__('Find', 'service-finder').' '.esc_html($providerreplacestring).'" class="btn btn-block btn-primary '.sanitize_html_class($btnclass).'">
    </div>
  </div>';
  ...
  if($service_finder_options['search-radius']){
   $html .= '<div class="col-md-6  col-sm-6">
                            ...
                            <input class="sf-radius-filter" name="distance" data-slider-id="ex1Slider" type="text" data-slider-min="'.esc_attr($minradiusrange).'" data-slider-max="'.esc_attr($maxradiusrange).'" data-slider-step="1" data-slider-value=""/>
