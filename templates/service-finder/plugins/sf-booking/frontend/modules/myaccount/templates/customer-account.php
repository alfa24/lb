...
<div class="profile-form-bx">
  <form class="pro-setting customer-update" method="post">
      ...
      <div class="profile-text-bx">
        <p><em>
          <?php esc_html_e('Update your avatar manually,If the not set the default Gravatar will be the same as your login email/user account.', 'service-finder'); ?>
          </em></p>
    ...
    <div class="panel-group accodian-style1" id="accordion">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title"> <a href="#collapse1" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" >
            <?php esc_html_e('About me', 'service-finder'); ?>
            </a> <i class="indicator glyphicon glyphicon-minus  pull-right"></i> </h4>
        </div>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title"> <a href="#collapse2" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" >
            <?php esc_html_e('Contact Detail', 'service-finder'); ?>
            </a> <i class="indicator glyphicon glyphicon-plus  pull-right"></i> </h4>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group"> <i class="input-group-addon fixed-w fa fa-user"></i>
                    <input type="text" class="form-control" name="phone2" value="<?php echo esc_attr($userInfo['phone2']) ?>">
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group"> <i class="input-group-addon fixed-w fa fa-user"></i>
                    <input type="text" class="form-control" name="user_email" value="<?php echo esc_attr($userInfo[0]->user_email) ?>">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title"> <a href="#collapse3" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group"> <i class="input-group-addon fixed-w fa fa-map-marker"></i>
                    <input type="text" class="form-control" name="address" id="customeraddress" value="<?php echo esc_attr($userInfo['address']) ?>">
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group"> <i class="input-group-addon fixed-w fa fa-map-marker"></i>
                    <input type="text" class="form-control" name="apt" id="customerapt" value="<?php echo esc_attr($userInfo['apt']) ?>">
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group"> <i class="input-group-addon fixed-w fa fa-map-marker"></i>
                    <input type="text" class="form-control" name="city" id="customercity" value="<?php echo esc_attr($userInfo['city']) ?>">
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group"> <i class="input-group-addon fixed-w fa fa-map-marker"></i>
                    <input type="text" class="form-control" name="state" id="customerstate" value="<?php echo esc_attr($userInfo['state']) ?>">
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group"> <i class="input-group-addon fixed-w fa fa-map-marker"></i>
                    <input type="text" class="form-control" name="zipcode" id="customerzipcode" value="<?php echo esc_attr($userInfo['zipcode']) ?>">
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group"> <i class="input-group-addon fixed-w fa fa-map-marker"></i>
                    <input type="text" class="form-control" name="country" id="customercountry" value="<?php echo esc_attr($userInfo['country']) ?>">
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title"> <a href="#collapse5" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion">
    ...
    <div class="form-group margin-0">
      ...
      <input type="reset" class="btn btn-custom" value="Reset">
    </div>
  </form>
</div>
