...
$viewtype = (isset($_GET['viewtype'])) ? esc_html($_GET['viewtype']) : '';
...
$providersInfoArr = $getProviders->service_finder_getProvidersCategory(get_queried_object()->term_id);
  ...
  wp_add_inline_script( 'bootstrap', 'jQuery(document).ready(function($) {
                ...
                function service_finder_loadCategoryResult(page,viewtype,numberofpages,setorderby,setorder){
					...
					var data = {
						...
						catid: "'.esc_js(get_queried_object()->term_id).'",
						viewtype: viewtype,
  ...
  wp_add_inline_script( 'bootstrap', 'jQuery(document).ready(function($) {
               ...
               // Handle the view types
				jQuery("body").on("click", "#viewTypes li", function(){
					...
					var homeurl = "'.esc_js(home_url("/providers-category/".get_query_var("providers-category"))).'";
					
					if(get_permalink){
					var homeurl = "'.esc_js(home_url("/providers-category/".get_query_var("providers-category"))).'";
					window.location = homeurl+"?catid='.esc_js(get_queried_object()->term_id).'&pagenum="+page+"&viewtype="+viewtype+"&numberofpages="+numberofpages+"&setorderby="+setorderby+"&setorder="+setorder;
						}else{
						var homeurl = "'.esc_js(home_url("/")."?providers-category=".get_query_var("providers-category")).'";
						window.location = homeurl+"&catid='.esc_js(get_queried_object()->term_id).'&pagenum="+page+"&viewtype="+viewtype+"&numberofpages="+numberofpages+"&setorderby="+setorderby+"&setorder="+setorder;
					}
				...
				jQuery("body").on("change", "#numberofpages", function(){
					...
					if(get_permalink){
					var homeurl = "'.esc_js(home_url("/providers-category/".get_query_var("providers-category"))).'";
					window.location = homeurl+"?catid='.esc_js(get_queried_object()->term_id).'&pagenum=1&viewtype="+viewtype+"&numberofpages="+numberofpages+"&setorderby="+setorderby+"&setorder="+setorder;
...
<div class="section-content">
   ...
   $providersInfoArr = $getProviders->service_finder_getProvidersCategory(get_queried_object()->term_id,$start,$per_page,$orderby,$order);
...
<div class="col-md-12 content">
  ...
  wp_add_inline_script( 'bootstrap', 'jQuery(document).ready(function($) {
				...
				if(get_permalink){
					var baseurl = "'.esc_js(home_url("/providers-category/".get_query_var("providers-category"))).'";
					var pageurl = baseurl+"?catid='.esc_js(get_queried_object()->term_id).'&pagenum="+startpage+"&viewtype="+viewtype+"&numberofpages="+numberofpages+"&setorderby="+setorderby+"&setorder="+setorder;
						}else{
						var baseurl = "'.esc_js(home_url("/")."?providers-category=".get_query_var("providers-category")).'";
						var pageurl = baseurl+"&catid='.esc_js(get_queried_object()->term_id).'&pagenum="+startpage+"&viewtype="+viewtype+"&numberofpages="+numberofpages+"&setorderby="+setorderby+"&setorder="+setorder;
					}
				...
				service_finder_loadCategoryResult(startpage,viewtype,numberofpages,setorderby,setorder);
				...
				jQuery("body").on("click", ".cvf_universal_container .cvf-universal-pagination li.activelink a", function(){
					...
					if(get_permalink){
					var baseurl = "'.esc_js(home_url("/providers-category/".get_query_var("providers-category"))).'";
					var pageurl = baseurl+"?catid='.esc_js(get_queried_object()->term_id).'&pagenum="+page+"&viewtype="+viewtype+"&numberofpages="+numberofpages+"&setorderby="+setorderby+"&setorder="+setorder;
						}else{
						var baseurl = "'.esc_js(home_url("/")."?providers-category=".get_query_var("providers-category")).'";
						var pageurl = baseurl+"&catid='.esc_js(get_queried_object()->term_id).'&pagenum="+page+"&viewtype="+viewtype+"&numberofpages="+numberofpages+"&setorderby="+setorderby+"&setorder="+setorder;
					}
				...
				jQuery("body").on("change", "#numberofpages", function(){
						...
						if(get_permalink){
						var baseurl = "'.esc_js(home_url("/providers-category/".get_query_var("providers-category"))).'";
						var pageurl = baseurl+"?catid='.esc_js(get_queried_object()->term_id).'&pagenum=1&viewtype="+viewtype+"&numberofpages="+numberofpages+"&setorderby="+setorderby+"&setorder="+setorder;
							}else{
							var baseurl = "'.esc_js(home_url("/")."?providers-category=".get_query_var("providers-category")).'";
							var pageurl = baseurl+"&catid='.esc_js(get_queried_object()->term_id).'&pagenum=1&viewtype="+viewtype+"&numberofpages="+numberofpages+"&setorderby="+setorderby+"&setorder="+setorder;
						}
    ...
    <div class="col-md-7 col-sm-7 col-xs-7">
      <form class="sort-filter-bx pull-right" action="?" method="get">
        <div class="f-f-left">
          <div class="form-group">
            <select class="form-control"  title="<?php esc_html_e('SORT BY','service-finder')?>" name="setorderby" id="setorderby">
              <option <?php echo ($setorderby == "rating") ? 'selected="selected"' : '' ?> value="rating">Rating</option>
              <option <?php echo ($setorderby == "title") ? 'selected="selected"' : '' ?> value="title">Title</option>
            </select>
          </div>
          <div class="form-group">
            <select class="form-control"  title="DESC" name="setorder" id="setorder">
              <option <?php echo ($setorder == "asc") ? 'selected="selected"' : '' ?> value="asc">ASC</option>
              <option <?php echo ($setorder == "desc") ? 'selected="selected"' : '' ?> value="desc">DESC</option>
            </select>
          </div>
          <div class="form-group">
            <select class="form-control"  title="9" name="numberofpages" id="numberofpages">
