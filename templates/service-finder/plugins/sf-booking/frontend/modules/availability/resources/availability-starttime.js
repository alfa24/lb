...
// When the browser is ready...
  jQuery(function() {
	...
	if(availabilitytab == "yes"){
		jQuery('#myTab a[href="#availability"]').tab('show');	
	}
    ...
    jQuery('.allstarttime')
        ...
        .on('success.form.bv', function(form) {
			...
			if(stimeval == ''){
				...
				jQuery( "<div class='alert alert-danger'>Please select start time</div>" ).insertBefore( "form.allstarttime" );
				return false;
			}
			
			if(wdays == undefined){
				jQuery(".alert-danger").remove();
				jQuery( "<div class='alert alert-danger'>Please select atleast one week day</div>" ).insertBefore( "form.allstarttime" );
				return false;
			}
