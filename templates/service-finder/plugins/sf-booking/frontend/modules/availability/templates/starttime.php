  ...
  <div class="auther-availability form-inr clearfix">
    ...
    <div class="section-content">
      <div class="row">
        ...
        <?php 
            ?>
          <select class="form-control" name="starttime" data-live-search="true" title="<?php esc_html_e('Start Time', 'service-finder'); ?>">
        ...
        <div class="col-md-4">
        <div class="form-group">
          <input type="text" name="maxbooking" class="form-control" placeholder="<?php esc_html_e('Max bookings','service-finder') ?>">
        </div>
        </div> 
        ...
        <div class="col-md-4">
          <div class="checkbox">
              <input type="checkbox" id="chk-<?php echo esc_attr(strtolower($weekdayname)); ?>" name="weekdays[]" value="<?php echo esc_attr(strtolower($weekdayname)); ?>">
              <label for="chk-<?php echo esc_attr(strtolower($weekdayname)); ?>"><?php echo esc_html__($weekdayname); ?></label>
            </div>
        </div>
					...
					foreach($starttimeinfo as $starttime){
						...
						echo '<li data-tid="'.esc_attr($starttime->id).'">
								...
								<div class="input-group">
									...
									<input type="text" value="'.esc_attr($starttime->max_bookings).'" id="maxbooking_'.esc_attr($starttime->id).'" name="maxbooking" class="form-control" placeholder="'.esc_html__('Number of bookings allowed','service-finder').'">
