    ...
    <thead>
      <tr>
        <th> <div class="checkbox">
          ...
          <button class="btn btn-danger btn-xs" id="deleteZipcodeTriger" title="Delete"><i class="fa fa-trash-o"></i></button></th>
          ...
          <div class="modal-body clearfix row input_fields_wrap">
            <div class="col-md-12">
              <div class="form-group">
                <textarea class="form-control" name="zipcode" id="areazipcode" placeholder="<?php esc_html_e('Add comma separate postal codes', 'service-finder'); ?>" rows="" cols="4"><?php echo (!empty($sAreas)) ? $sAreas : ''; ?></textarea>
