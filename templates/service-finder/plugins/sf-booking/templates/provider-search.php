...
$providersInfo = $getProviders->service_finder_getSearchedProviders(esc_attr($distance),esc_attr($minprice),esc_attr($maxprice),esc_attr($keyword),esc_attr($address),esc_attr($city),esc_attr($catid),esc_attr($country));
...
<div class="page-content clearfix">
  ...
  <?php
		...
		if($service_finder_options['search-header-style'] == 'map'){
		?>
